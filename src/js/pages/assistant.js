...
function appendMessage(message) { const bubble = el("article", { className: `chat-message ${message.role}` }, [el("span", { text: message.role === "assistant" ? "EduPulse coach" : "You" }), el("p", { text: message.content })]); messages.append(bubble); messages.scrollTop = messages.scrollHeight; }
